...
public class DriveTrain extends SubsystemBase {
    ...
    private double deltaMetersLeft = 0;
    private double deltaMetersRight = 0;
    ...
    public void periodic() {
        ...
        deltaMetersLeft = RoboMath.ticksToMeters(leftMaster.getSelectedSensorPosition(0) - deltaMetersLeft);
        deltaMetersRight = RoboMath.ticksToMeters(rightMaster.getSelectedSensorPosition(0) - deltaMetersRight);
